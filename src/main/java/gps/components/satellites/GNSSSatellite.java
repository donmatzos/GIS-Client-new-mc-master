...
public class GNSSSatellite extends SatelliteInfo
{
    public GNSSSatellite(final int id, final double verticalAngularDistance, final double horizontalAngularDistance,
                            final int snr)
    {
    ...
    public void draw(final Graphics2D graphics, final Point point)
    {
        ...
        poly.addPoint(point.x+(SATELLITE_SIZE/2), point.y);
