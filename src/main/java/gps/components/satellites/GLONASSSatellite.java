...
public class GLONASSSatellite extends SatelliteInfo
{
    public GLONASSSatellite(final int id, final double verticalAngularDistance, final double horizontalAngularDistance,
                            final int snr)
    {
